	...
	tinymce.create('tinymce.plugins.AdvancedImagePlugin', {
		init : function(ed, url) {
			...
			ed.onPreInit.add(function() {
				ed.serializer.addRules('img[id|class|longdesc|usemap|src|border|alt=|title|hspace|vspace|width|height|align|dedtparams=|onmouseover|onmouseout|onclick|ondblclick|style]');
			});
			/* BEGIN: delight lukas */
