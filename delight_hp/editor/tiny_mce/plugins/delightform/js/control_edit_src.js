...
var DelightEditFieldDialog = {
	...
	__insertElement : function(o) {
		...
		if (o.type == 'multi') {
			html = '<textarea name="' + o.name + '" title="' + o.description + '" id="' + ed.dom.uniqueId('form_') + '" class="' + (o.validation!='text' ? o.validation : '') + (o.mandatory ? ' mandatory' : '') + '" style="height:' + (o.rows) + 'px;width:' + (o.size) + 'px;">' + o.value + '</textarea>';
		} else {
			html = '<input type="' + o.type + '" name="' + o.name + '" value="' + o.value + '" title="' + o.description + '" id="' + ed.dom.uniqueId('form_') + '" class="' + (o.validation!='text' ? o.validation : '') + (o.mandatory ? ' mandatory' : '') + '" style="width:' + (o.size) + 'px;" />';
		}
