/**
 * $Id: editor_plugin_src.js,v 1.3 2009/10/15 11:28:57 lukas Exp $
 *
 * @author Moxiecode
...
//			f.top -= po.y;
			...
			// LUKAS: Added in case of an invalid "clientWidth" on the two borders left and right
			if (!f.type) {
				window.setTimeout(function(){
					w.deltaWidth = DOM.get(id + '_left').clientWidth + DOM.get(id + '_right').clientWidth;
					w.deltaHeight = DOM.get(id + '_top').clientHeight + DOM.get(id + '_bottom').clientHeight;
					w.element.resizeTo(f.width+w.deltaWidth, f.height+w.deltaHeight);
				}, 100);
			}
