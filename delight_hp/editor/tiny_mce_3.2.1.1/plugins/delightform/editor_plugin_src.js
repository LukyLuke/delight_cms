	...
	tinymce.create('tinymce.plugins.DelightFormular', {
		...
		init : function(ed, url) {
			...
			ed.onPreInit.add(function() {
				...
				ed.serializer.addRules('span[name|value|formclass|style|selected]');
				ed.serializer.addRules('input[type|name|value|class|style|disabled|ismap|maxlength|tabindex|usemap|checked|accesskey|accept|alt|readonly|title]');
				ed.serializer.addRules('select[name|class|style|disabled|multiple|tabindex|accesskey|alt|title]');
				ed.serializer.addRules('option[disabled|label|selected|value]');
			});
