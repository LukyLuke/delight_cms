...
var DelightRadioFieldDialog = {
	...
	__replaceElement : function(o) {
		...
		//n.setAttribute('id', o.name + t.getElem('cb_name').options.length);
	...
	__insertElement : function(o) {
		...
		html = '<input type="radio" id="' + o.name + t.getElem('cb_name').options.length + '" name="' + o.name + '" title="' + o.description+ '" value="'+o.value+'" class="radio' + (o.mandatory ? ' mandatory' : '') + '" />';
