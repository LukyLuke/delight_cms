/**
 * $Id: editor_plugin_src.js,v 1.1.1.1 2009/01/07 20:09:07 lukas Exp $
 *
 * @author Moxiecode
			...
			switch (command) {
				...
				case "mceTableRowProps":
					...
					if (user_interface) {
						inst.windowManager.open({
							url : url + '/row.htm',
							width : 410 + parseInt(inst.getLang('table.rowprops_delta_width', 0)),
							height : 300 + parseInt(inst.getLang('table.rowprops_delta_height', 0)),
							inline : 1
						}, {
							plugin_url : url
						});
				...
				case "mceTableCellProps":
					...
					if (user_interface) {
						inst.windowManager.open({
							url : url + '/cell.htm',
							width : 515 + parseInt(inst.getLang('table.cellprops_delta_width', 0)),
							height : 300 + parseInt(inst.getLang('table.cellprops_delta_height', 0)),
							inline : 1
						}, {
							plugin_url : url
						});
				...
				case "mceInsertTable":
					if (user_interface) {
						inst.windowManager.open({
							...
							height : 325 + parseInt(inst.getLang('table.table_delta_height', 0)),
							inline : 1
						}, {
							plugin_url : url,
							...
							if (tinymce.isIE || sel.rangeCount == 1) {
								if (user_interface) {
									...
									inst.windowManager.open({
										...
										width : 250 + parseInt(inst.getLang('table.merge_cells_delta_width', 0)),
										height : 115 + parseInt(inst.getLang('table.merge_cells_delta_height', 0)),
										inline : 1
									}, {
										action : "update",
										numcols : sp.colspan,
