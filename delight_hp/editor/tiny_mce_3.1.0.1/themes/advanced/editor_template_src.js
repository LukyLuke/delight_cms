/**
 * $Id: editor_template_src.js,v 1.1.1.1 2009/01/07 20:08:44 lukas Exp $
 *
 * @author Moxiecode
...
*/
		...
		_nodeChanged : function(ed, cm, n, co) {
			...
			p = DOM.getParent(n, 'IMG');
			if (c = cm.get('image'))
				c.setActive(!!p && (n.className.indexOf('mceItem') == -1) && (n.className.indexOf('mceplgItem') == -1));
		...
		_mceInsertAnchor : function(ui, v) {
			...
			ed.windowManager.open({
				...
				width : 330 + parseInt(ed.getLang('advanced.anchor_delta_width', 0)),
				height : 95 + parseInt(ed.getLang('advanced.anchor_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
