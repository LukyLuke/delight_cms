var DateFormat = Class.create({
	...
	parseFormat: function(val,format) {
		...
		return this._parseFormat(val, format);
	},
	doFormat: function(value,format) {
		if (typeof(format) == 'undefined') {
			format = this.format;
		}
	...
	compareDates: function(date1,dateformat1,date2,dateformat2) {
		var d1=this._parseFormat(date1,dateformat1);
		var d2=this._parseFormat(date2,dateformat2);
	...
	_parseFormat: function(val,format) {
		val=val+"";
		format=format+"";
		var i_val=0;
		var i_format=0;
...
Object.extend(Date, {
	format: function(format) {
		var f = new DateFormat(format);
		return f.doFormat(this);
	}
});
