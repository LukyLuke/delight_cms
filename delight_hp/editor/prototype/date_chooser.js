...
//		this.options.currentFormat = this.options.timePicker ? this.options.dateTimeFormat : this.options.dateFormat;
		var format = new DateFormat(this.options.currentFormat);
		this.options.date = format.parse(this.element.value);
	...
	datePicked: function(date) {
		var f = new DateFormat(this.options.currentFormat);
		this.element.value = f.doFormat(date);
		this.element.focus();
		this.hide();
	...
	show: function () {
		if (!this.pickerActive) {
			...
			var f = new DateFormat(this.options.currentFormat);
			this.datepicker.selectDate(f.parseFormat(this.element.value));
