...
if (file_exists("./admin/plugin_1500/main_statistic.cls.php"))
	...
	class statistic_class_referer_client extends statistic_class_main
	{
		function statistic_class_referer_client()
		{
			statistic_class_main::statistic_class_main();
			$this->_pluginName   = 'referer_client';
			$this->_pluginSymbol = 'statistic_referer_client.gif';
		}
		...
		{
			$sql  = "SELECT ".$this->DB->Field('ref','browser')."";
