...
if (file_exists("./admin/plugin_1500/main_statistic.cls.php"))
	...
	class statistic_class_referer_country extends statistic_class_main
	{
		function statistic_class_referer_country()
		{
			statistic_class_main::statistic_class_main();
			$this->_pluginName   = 'referer_country';
			$this->_pluginSymbol = 'statistic_referer_country.gif';
		}
		...
		{
			$sql  = "SELECT ".$this->DB->Field('ref','domain')."";
