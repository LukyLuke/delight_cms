...
define('PRIVACY_POLICY_LINK',   '<strong class="privacyPolicy" onclick="window.open(\''.MAIN_DIR.'/privacy_policy.php?lan=[LANGUAGE]\',\'privacypolicy\',\'width=350px,height=450px,locationbar=no,statusbar=no,menubar=no,toolbar=no,resizable=yes\');\">[LINK_TEXT]</strong>');
